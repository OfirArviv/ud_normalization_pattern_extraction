...
class Token(object):
    ...
    def copy(self, new_id=None, form=None, lemma=None, upos=None, xpos=None, feats=None, head=None, deprel=None,
             deps=None, misc=None):
    ...
    def get_conllu_string(self):
        ...
        self._conllu_info["deps"] = "|".join(
            [str(a.get_conllu_field('id')) + ":" + b for (a, b) in sorted(self.get_new_relations())])
